        ...
        switch ($action) {
            case 'add':
                ...
                if (empty($semester_name) || empty($start_date) || empty($end_date)) {
                    ...
                    $insert_query = "INSERT INTO semesters (semester_name, start_date, end_date) VALUES (?, ?, ?)";
            ...
            case 'edit':
                ...
                if (empty($semester_id) || !is_numeric($semester_id) || $semester_id <= 0 || empty($updated_semester_name) || empty($updated_start_date) || empty($updated_end_date)) {
                    ...
                    $update_query = "UPDATE semesters SET semester_name = ?, start_date = ?, end_date = ? WHERE id = ?";
            ...
            case 'delete':
                ...
                if ($semester_id === null || !is_numeric($semester_id) || $semester_id <= 0) {
                    ...
                    $delete_query = "DELETE FROM semesters WHERE id = ?"; // Delete based on 'id' column
