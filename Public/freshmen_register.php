...
// Check if the student is a first-year student.  You'll need to adapt this logic
// to match your actual database schema and how you store year information.
// Check if $student_info is not NULL and contains the key 'year'
//$is_first_year = (is_array($student_info) && isset($student_info['year']) && $student_info['year'] == 1);  // Remove this line

//if (!$is_first_year) {
//  Normally, you would redirect to the dashboard or display a message.
//  For demonstration, we'll just display a message here.  You'll
//  move this logic into dashboard.php later.
//  echo "<div style='font-family: Kanit, sans-serif; padding: 20px; background-color: #f4f4f4;'>";
//echo "<h1 style='color: rgb(222, 92, 142);'>หน้าลงทะเบียนแรกเข้าสำหรับนิสิตใหม่</h1>";
//echo "<p>หน้านี้ใช้สำหรับนิสิตปี 1 เท่านั้น</p>";
//echo "<p><a href='dashboard.php' style='background-color: #007BFF; color: white; padding: 10px 15px; border-radius: 5px; text-decoration: none;'>กลับสู่แดชบอร์ด</a></p>";
//echo "</div>";
...
$faculties = getFaculties($student_code); // Pass the student code
$majors = getMajors($student_code);    // Pass the student code
            ...
            <div class="form-group">
                ...
                <select name="major_id">
                    <?php foreach ($majors as $major) : ?>
                        <option value="<?php echo $major['major_id']; ?>" <?php if (isset($student_info['major_id']) && $student_info['major_id'] == $major['major_id']) echo 'selected'; ?>>
