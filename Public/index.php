...
<head>
    ...
    <title>ระบบ E-Service มหาวิทยาลัย</title>
...
<body>
    <div class="container">
        <h1>EDU CU E-Service</h1>
        <p>ยินดีต้อนรับสู่ EDU CU E-Service ระบบที่จะช่วยให้คุณจัดการข้อมูลและกิจกรรมต่างๆ ภายในคณะครุศาสตร์ จุฬาลงกรณ์มหาวิทยาลัย ได้อย่างสะดวกและรวดเร็ว</p>
        <div>
            <t>สำหรับนิสิต</t>
            <a href="login.php" class="cta-button">เข้าสู่ระบบ</a>
        </div>
            <t>สำหรับเจ้าหน้าที่หรืออาจารย์ เท่านั้น</t>
            <a href="../Public/admin/admin-login.php" class="admin-button">เข้าสู่ระบบสำหรับเจ้าหน้าที่</a>
        <div class="features">
        ...
        <footer>
            ...
            <p>เป็นส่วนหนึ่งของรายวิชา 2766223 FUND DATA VIS</p>
